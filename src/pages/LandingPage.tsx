      ...
      <div className="fw-landing__shell">
        ...
        <section className="fw-landing__hero" id="start">
          <div className="fw-landing__hero-copy">
            ...
            <p className="fw-landing__subtitle">
              ...
              streaks saved on your device, and clear rules. Great for football
              fans of all levels.
            </p>
        ...
        <section className="fw-section" id="about">
          ...
          <div className="fw-feature-grid">
            <article className="fw-feature">
              <h3>Fresh lists</h3>
              <p>
                Players include recent transfers and rising talents; clubs cover
                top-flight leagues and continental competitions.
              </p>
            </article>
            <article className="fw-feature">
              <h3>Two modes, endless rounds</h3>
              <p>
                Use "Guess players" to test your footballer knowledge, or "Guess
                clubs" to work through top-flight teams. Play as many rounds as
                you like.
              </p>
            </article>
            <article className="fw-feature">
        ...
        <section className="fw-section fw-section--panel" id="how-to-play">
          <div className="fw-section__header">
            ...
            <p className="fw-section__lead">
              Pick a mode and type a name each turn. Colors show if a letter is
              in the right spot (green), in the word (yellow), or not present
              (red).
            </p>
          </div>
          ...
          <div className="fw-steps">
            ...
            <article className="fw-step">
              ...
              <div>
                ...
                <p>
                  ...
                  mobile you get an accessible input that stays out of the way.
                </p>
              </div>
            </article>
            <article className="fw-step">
            ...
            <article className="fw-step">
              ...
              <div>
                ...
                <p>
                  Stats stay on your device (localStorage). No email or sign-up
                  required to play.
                </p>
              </div>
            </article>
        ...
        <section className="fw-section" id="features">
          ...
          <div className="fw-feature-grid">
            ...
            <article className="fw-feature">
              <h3>Curated lists</h3>
              <p>
                Popular players and clubs from European and American leagues so
                each round feels relevant to fans.
              </p>
            </article>
            <article className="fw-feature">
              <h3>Distraction-free layout</h3>
              <p>
                The board, keyboard, and hints stay front and center. No pop-ups
                or overlays that block gameplay.
              </p>
            </article>
            <article className="fw-feature">
              <h3>Fair play</h3>
            ...
            <article className="fw-feature">
              <h3>Changelog</h3>
              <p>
                We keep a short record of list updates and UI tweaks so players
          ...
          <div className="fw-steps">
            <article className="fw-step">
              ...
              <div>
                ...
                <p>
                  We save streaks and stats in your browser only. Clearing your
                  cache removes them. Nothing leaves your device.
                </p>
              </div>
            </article>
            <article className="fw-step">
        ...
        <section className="fw-section fw-section--panel" id="faq">
          ...
          <div className="fw-faq">
            <div className="fw-faq__item">
              ...
              <p>
                Only progress and streaks in your browser via local storage. We
                do not ask for email or force any forms.
              </p>
            </div>
            <div className="fw-faq__item">
